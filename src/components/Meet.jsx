...
const Meet = () => {
  return (
    <div className="max-w-[1140px] mx-auto px-3 ">
      <h2  data-aos="zoom-in"
          data-aos-once="true" className="text-[33px] md:text-[64px] font-normal leading-[108%] text-white font-azo text-center pt-5 md:pt-[110px]">
        Meet The Team
      </h2>
      <div className="max-w-[1140px] h-1 bg-[#FDDA60] mt-12 border-none shadow-[0_0_15px_0_#FDDA60]"></div>
      <div data-aos="flip-up" data-aos-once="true" className="flex flex-wrap">
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          ...
          <div className=" rounded-[20px] border-[3px] border-[#FDDA60] w-[230px] h-[230px] mt-8 shadow-[0_0_15px_0_#FDDA60] overflow-hidden">
            <img
              className=" rounded-[20px] hover:scale-[1.1] duration-300"
              src={meet1}
              alt="meet"
            />
          </div>
        ...
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          ...
          <p className="text-xl font-normal leading-[108%] font-Montserrat text-white pt-3 items-start md:items-center text-center md:text-start">
            Nearly two decades in Business
          </p>
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-8 items-start md:items-center text-center md:text-start">
          ...
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-2 items-start md:items-center text-center md:text-start">
            {" "}
      ...
      <div data-aos="flip-up" data-aos-once="true" className="flex flex-wrap ">
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          <h2 className="text-2xl font-bold leading-[108%] font-Montserrat text-white text-center md:text-start">
            Talan Passaquindici Arcand
          </h2>
          <p className="text-xl font-normal leading-[108%] font-Montserrat text-white pt-3 text-center md:text-start">
        ...
        <div className=" w-full md:w-1/2 pt-6 flex flex-col items-center md:items-start">
          <p className="text-2xl font-semibold text-white font-Montserrat leading-[108%] text-center md:text-start">
            @Talan Passaquindici Arcand
          </p>
          <p className="text-xl font-normal leading-[108%] font-Montserrat text-white pt-3 text-center md:text-start">
            Invester & International Top Model
          </p>
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-8 text-center md:text-start">
          ...
          <p className="text-bace font-normal font-Montserrat text-white leading-[160%] pt-2 text-center md:text-start">
            {" "}
